...
lap_times_df = spark.read \
                ...
                .csv(f"abfss://raw@dlkt.dfs.core.windows.net/lap_times")
...
final_df.write.mode("overwrite").partitionBy('race_id').format("delta").save(f"{presentation_folder_path}/lap_times")
